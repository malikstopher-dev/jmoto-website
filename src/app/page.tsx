...
export default function Home() {
  ...
  return (
    <>
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-end lg:items-center overflow-hidden bg-jmoto-black">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-t from-jmoto-black via-jmoto-black/30 to-transparent z-10 lg:bg-gradient-to-r lg:from-jmoto-black lg:via-jmoto-black/60 lg:to-transparent" />
          <div className="absolute inset-0">
            <picture>
              <source
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-32 pb-16 lg:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-6 hero-content">
              <div className="lg:bg-transparent lg:p-0">
                <div ref={eyebrowRef} className="font-display text-jmoto-red text-xs sm:text-sm tracking-[0.2em] mb-4 lg:mb-6">
                  {t.hero.eyebrow}
                </div>

                <div ref={headlineRef}>
                  <h1 className="text-3xl sm:text-4xl lg:text-6xl xl:text-7xl font-bold text-white leading-[1.05] tracking-tight mb-4 lg:mb-6">
                ...
                <div ref={subRef}>
                  <p className="text-white/60 text-sm sm:text-base lg:text-xl leading-relaxed mb-6 lg:mb-8 max-w-xl">
                    {t.hero.subheadline}
                  </p>
                </div>
                ...
                <div ref={ctaRef} className="flex flex-col sm:flex-row gap-3">
                  <Link
                    href="/quote"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 sm:px-7 sm:py-3.5 bg-jmoto-red hover:bg-jmoto-red-bright text-white font-semibold rounded-lg transition-all duration-200 shadow-lg shadow-jmoto-red/25 hover:shadow-jmoto-red/40 text-sm"
                  >
                    {t.hero.getAQuote}
                  ...
                  <Link
                    href="/services"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 sm:px-7 sm:py-3.5 bg-white/10 hover:bg-white/15 text-white font-medium rounded-lg transition-all duration-200 backdrop-blur-sm border border-white/10 text-sm"
                  >
                    {t.hero.viewServices}
                  </Link>
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 sm:px-7 sm:py-3.5 bg-green-600 hover:bg-green-500 text-white font-medium rounded-lg transition-all duration-200 text-sm"
                  >
                ...
                <div className="mt-8 lg:mt-10 flex items-center gap-3">
                  ...
                  <span className="font-display text-white/40 text-xs sm:text-sm tracking-[0.15em]">{t.hero.brandLine}</span>
                </div>
              </div>
            </div>
