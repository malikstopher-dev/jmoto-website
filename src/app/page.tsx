    ...
    <>
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center overflow-hidden bg-jmoto-black">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-r from-jmoto-black via-jmoto-black/80 to-transparent z-10" />
          <div className="absolute inset-0">
            <picture>
              <source
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-jmoto-black via-transparent to-jmoto-black/30 z-10" />
        </div>
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-6 hero-content">
              ...
              <div ref={subRef}>
                <p className="text-white/50 text-base sm:text-lg lg:text-xl leading-relaxed mb-8 max-w-xl">
                  {t.hero.subheadline}
                </p>
              </div>
