...
const saleProducts = [
  ...
  { key: "plugs", icon: "🔌", images: ["/shop-images/Plugs & Adaptors.png"] },
  { key: "switches", icon: "🔘", images: ["/shop-images/Switches & Sockets.png"] },
  { key: "ledBulbs", icon: "💡", images: ["/shop-images/LED Bulbs.png"] },
  { key: "cables", icon: "🔗", images: ["/shop-images/Cables & Wiring.png"] },
  { key: "circuitBreakers", icon: "⚡", images: ["/shop-images/Circuit Breakers.png"] },
  { key: "cctvAccessories", icon: "📹", images: ["/shop-images/CCTV Accessories.png"] },
  { key: "solarAccessories", icon: "☀️", images: ["/shop-images/Solar & Inverter Accessories.png"] },
  { key: "extensionLeads", icon: "🔌", images: ["/shop-images/Extension Leads.png"] },
];
