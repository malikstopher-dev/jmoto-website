          ...
          <div className="space-y-1">
            ...
            <div className="pt-4 flex flex-col gap-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 px-4 py-3 bg-white/[0.05] hover:bg-white/[0.08] text-white font-medium rounded-xl transition-colors border border-white/[0.06]"
              >
              ...
              <Link
                href="/quote"
                className="block text-center px-4 py-3 bg-jmoto-red hover:bg-jmoto-red-bright text-white font-semibold rounded-xl transition-colors shadow-lg shadow-jmoto-red/20"
                onClick={() => setIsMenuOpen(false)}
              >
                {t.nav.getAQuote}
              </Link>
